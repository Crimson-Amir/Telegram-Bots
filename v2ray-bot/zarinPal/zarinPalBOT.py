...
text = ("<b>• اطلاعات زیر رو بررسی کنید و در صورت تایید پرداخت رو نهایی کنید:</b>"
        ...
        "\n<b>🟡 لطفا تا انتهای فرایند پرداخت مرورگر رو نبندید و مطمئن بشید جواب سرور رو دریافت میکنید."
        "\nاگر جواب سرور برای شما نمایش داده نشد و داخل ربات پیامی مبنی بر تایید پرداخت مشاهده نشد، مبلغ تا نهایتا 48 ساعت به حساب شما برگردانده میشود.</b>"
        )
