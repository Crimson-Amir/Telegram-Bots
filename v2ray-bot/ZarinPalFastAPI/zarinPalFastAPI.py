...
async def recive_payment_result(Authority: str, Status: str, request: Request):
    ...
    if Status == 'OK':
        ...
        if not get_from_data:
            ...
            return templates.TemplateResponse(request=request, name='fail/fail_pay.html',
        ...
        if response.get('data').get('code') == 100:
            ...
            return templates.TemplateResponse(request=request, name='fail/fail_pay.html', context={'error_reason': reason, 'error_code': error_code})
